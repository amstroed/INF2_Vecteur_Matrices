...
int main() {
	...
	Vecteur<int> v1 = v;
	Vecteur<int> v2(4);
	cout << "elements de v1 : " << v1 << " taille de v1 : " << v1.size()
			<< endl;
	v2 = v1;
	v1.at(2) = v2.at(3);
	...
	cout << "Somme des elements de chaque ligne de m1 : " << m1.sommeLigne()
			<< endl;
	cout << "Somme des elements de chaque colonne de m1 : " << m1.sommeColonne()
			<< endl;
	cout << "Somme de la diagonale GD de m1 : " << m1.sommeDiagonaleGD()
			<< endl;
	cout << "Somme de la diagonale DG de m1 : " << m1.sommeDiagonaleDG()
			<< endl;
	cout << "Elements de m1 : " << m1 << endl;
	cout << "Elements de m1 multiplies par 3 : " << m1 * 3 << endl;
	m1 = m2 * m1;
	cout << "elements de m1 apres multiplication par les elements de m2" << m1
			<< endl;
	m1 = m2 + m1;
	cout << "Elements de m1 apres addition avec les elements de m2" << m1
			<< endl;
	m1.resize(3, 3);
